...
X = tokenizer.texts_to_sequences(df1['text'])   #turning each text into a sequence of integers (each integer being the index of a token in a dictionary)

X = pad_sequences(X)                            #pad_sequences to convert the sequences into 2-D numpy array.
